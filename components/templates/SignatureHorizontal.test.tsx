...
import { SignatureHorizontal } from './SignatureHorizontal';
...
describe('SignatureHorizontal', () => {
  it('renders with only required fields', () => {
    render(<SignatureHorizontal data={required} style={{}} />);
  ...
  it('renders a logo image instead of the company name when logoUrl is present', () => {
    render(<SignatureHorizontal data={{ ...required, logoUrl: 'https://abc.com/logo.png' }} style={{}} />);
  ...
  it('renders optional website and social links when present', () => {
    render(<SignatureHorizontal data={{ ...required, website: 'https://abc.com', linkedin: 'https://linkedin.com/in/juan' }} style={{}} />);
  ...
  it('renders the WhatsApp phone number as a wa.me link, not a relative href', () => {
    render(<SignatureHorizontal data={{ ...required, whatsapp: '+63 917 123 4567' }} style={{}} />);
  ...
  it('applies an accent color override', () => {
    const { container } = render(<SignatureHorizontal data={required} style={{ accentColor: '#ff0000' }} />);

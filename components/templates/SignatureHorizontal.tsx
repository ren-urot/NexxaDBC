...
export function SignatureHorizontal({ data, style }: TemplateProps) {
  ...
  return (
    <div
      className="flex w-[560px] flex-col overflow-hidden rounded-3xl bg-white shadow-lg"
    ...
    >
      ...
      <div className="flex flex-1 flex-row gap-6 px-6 py-6">
        ...
        <div className="flex flex-1 flex-col justify-center gap-1.5 text-right text-sm text-gray-500">

...
import { SkylineVertical } from './SkylineVertical';
...
describe('SkylineVertical', () => {
  it('renders with only required fields', () => {
    render(<SkylineVertical data={required} style={{}} />);
  ...
  it('renders the WhatsApp phone number as a wa.me link, not a relative href', () => {
    render(<SkylineVertical data={{ ...required, whatsapp: '+63 917 123 4567' }} style={{}} />);
  ...
  it('renders a logo image when logoUrl is present', () => {
    render(<SkylineVertical data={{ ...required, logoUrl: 'https://abc.com/logo.png' }} style={{}} />);
  ...
  it('applies an accent color override', () => {
    const { container } = render(<SkylineVertical data={required} style={{ accentColor: '#ff0000' }} />);

...
import { ProfessionalHorizontal } from './ProfessionalHorizontal';
...
describe('ProfessionalHorizontal', () => {
  it('renders with only required fields', () => {
    render(<ProfessionalHorizontal data={required} style={{}} />);
  ...
  it('renders optional website and social links when present', () => {
    render(<ProfessionalHorizontal data={{ ...required, website: 'https://abc.com', linkedin: 'https://linkedin.com/in/juan' }} style={{}} />);
  ...
  it('applies an accent color override', () => {
    const { container } = render(<ProfessionalHorizontal data={required} style={{ accentColor: '#ff0000' }} />);

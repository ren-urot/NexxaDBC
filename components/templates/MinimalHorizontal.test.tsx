...
import { MinimalHorizontal } from './MinimalHorizontal';
...
describe('MinimalHorizontal', () => {
  it('renders with only required fields', () => {
    render(<MinimalHorizontal data={required} style={{}} />);
  ...
  it('applies an accent color override to the divider', () => {
    render(<MinimalHorizontal data={required} style={{ accentColor: '#ff0000' }} />);

...
import { ModernHorizontal } from './ModernHorizontal';
...
describe('ModernHorizontal', () => {
  it('renders with only required fields', () => {
    render(<ModernHorizontal data={required} style={{}} />);
  ...
  it('renders optional website and social links when present', () => {
    render(<ModernHorizontal data={{ ...required, website: 'https://abc.com', linkedin: 'https://linkedin.com/in/juan' }} style={{}} />);
  ...
  it('applies an accent color override', () => {
    const { container } = render(<ModernHorizontal data={required} style={{ accentColor: '#ff0000' }} />);
